...
Usage
-----
    python compare_data_ratio.py -p configs/lensing/mass_ratio_data_z05.yaml
"""
...
def main(path2config: str, verbose: bool = True) -> None:
    ...
    # ---- Save figure ----
    out_stem = f'kSZ_fig_{pType}_{pType2}_{fig_name}_z{redshift}_{filter_type}_{filter_type2}'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-p', '--path2config',
        type=str,
        default='./configs/lensing/kSZ_data_z05.yaml',
