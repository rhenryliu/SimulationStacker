"""
make_stackArea.py (archived as archive/make_stackArea_v1.py)
============================================================
Frozen copy of the pre-FLAMINGO Figure 4 script, kept so the original 2x3
figure stays reproducible.  unbound_gas/make_stackArea.py has since moved to
two 3x2 figures with FLAMINGO; run this copy from the scripts/ directory with
its original config:

    python archive/make_stackArea_v1.py -p ./configs/unbound_gas/stackArea_z05.yaml
