...
# srun python -u simulated_maps.py -p ./configs/map_z05_cumulative.yaml
# srun python -u simulated_maps.py -p ./configs/map_z05_CAP.yaml
...
# srun python -u make_2D_ratios2x2.py -p ./configs/mass_ratio_z00.yaml
# srun python -u make_3D_profiles2x2.py -p ./configs/3D_mass_ratio_z00.yaml
# srun python -u mask_sims_3D.py -p ./configs/3D_masked_profiles_z05.yaml
# srun python -u mask_haloes_visual.py
# srun python -u simulated_SZ_ratio.py -p ./configs/kSZ_ratio_z05.yaml
# srun python -u make_2D_ratios2x2.py -p ./configs/mass_ratio_z05.yaml

# srun python -u simulated_mass_ratio.py -p ./configs/mass_ratio_data_z026.yaml
...
# srun python -u simulated_kSZ_masked.py 
